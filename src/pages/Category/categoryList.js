...
import {remove,showUpdate,showCreate} from './categoryActions'
...
class CategoryList extends Component {
    ...
    render() {
        ...
        return (
            <Content title='Category' loading={this.props.loading} >
...
const selector = formValueSelector('CategoryFormList')
...
CategoryList = reduxForm({ form: 'CategoryFormList', destroyOnUnmount: false })(CategoryList)

const ShowTheLocationWithRouter = withRouter(CategoryList)
